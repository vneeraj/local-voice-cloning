...
> This is the Claude Code context file for the Conductor framework. If this project also contains a `GEMINI.md` file, both agents share the same `conductor/` data files — all artifacts, status markers, and file schemas are identical between agents for full interoperability.
